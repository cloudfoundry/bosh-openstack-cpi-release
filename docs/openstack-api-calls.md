...
POST /v2/<tenant_id>/servers.json body: {"server":{"flavorRef":"<resource_id>","imageRef":"<resource_id>","name":"<name>","user_data":"<user_data>","key_name":"<key_name>","config_drive":true,"security_groups":[{"name":"<name>"}],"networks":[{"uuid":"<resource_id>","port":"<resource_id>"},{"uuid":"<resource_id>","port":"<resource_id>"}]}}
