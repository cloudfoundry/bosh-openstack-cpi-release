...
ensure_not_replace_value BOSH_OPENSTACK_NO_DHCP_MANUAL_IP_1
ensure_not_replace_value BOSH_OPENSTACK_NO_DHCP_MANUAL_IP_2
ensure_not_replace_value BOSH_OPENSTACK_NET_ID
ensure_not_replace_value BOSH_OPENSTACK_NET_ID_NO_DHCP_1
ensure_not_replace_value BOSH_OPENSTACK_NET_ID_NO_DHCP_2
...
ensure_not_replace_value BOSH_OPENSTACK_FLAVOR_WITH_NO_ROOT_DISK
optional_value BOSH_OPENSTACK_CA_CERT
optional_value BOSH_OPENSTACK_VOLUME_TYPE
